...
export const DataTreatments = [
    ...
    },
    {
        ...
        warning: 'Innan besöket är det VIKTIGT att du kollar upp fläckarna att dem är godartade. Vårtor kan krävas fler behandlingar.'
    },
    {
        name: 'EM Slim Sculpt',
        ...
        image: BackgroundIMG,
        id: 9,
        detailedDescription: 'Vilka fördelar har EM Slim Sculpt, Stärker kroppens muskulatur, Ökar fettförbränningen, Bra komplement till vanlig träning för att tona muskulaturen på de ställen som träningen inte ger resultat. Rehabträning på svag muskulatur så som delad magmuskel efter ex. graviditet, Tidseffektiv 30 000 kontraktioner på 30 min. Vilka muskler kan tränas och tonas?',
        list: [
